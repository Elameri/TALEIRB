	  ...
	  <div class="container h-100">
		<div class="row h-100 align-items-center">
		  <div class="col-12 text-center">
			<h1 class="font-weight-light">I want to :</h1>

				<div class="col-auto my-1"> 
					
					<a href="change_one_transac.php"><button type="submit" class="btn btn-success">Modify this Transaction</button></a>
					<a href="cancel_one_transac.php"><button type="button" class="btn btn-danger">Close this Transaction</button></a>
